      ...
      <div className="slider-container w-full h-full ">
        <Slider {...settings}>
          {clientSays?.map((client, index) => (
            <div
              key={index}
              className="p-12 border-[1px] border-[#e1e3e5] rounded-lg"
            >
              <p className="mb-4 client_say_description text-2xl text-[#636270] font-inter font-normal">
                {client?.description}
              </p>
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-2xl mb-1.5 text-[#272343] font-inter font-medium capitalize">
                    {client?.name}
                  </h4>
