...
const Banner = () => {
  ...
  return (
    <div className="lg:container w-full m-5 p-5">
          ...
          {products?.map((product) => (
            <div key={product?.id} className="banner_slide_item">
              ...
              <div className="banner_text">
                ...
                <button className="max-w-[171px] m-10 w-full flex items-center justify-center gap-2 h-[52] bg-[#029fae] rounded-lg cursor-pointer text-white capitalize">
                  shop now <MoveRight />
                </button>
              </div>
