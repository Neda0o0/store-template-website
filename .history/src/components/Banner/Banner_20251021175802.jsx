          ...
          {products?.map((product) => (
            <div key={product?.id} className="banner_slide_item">
              ...
              <div className="banner_text">
                ...
                <button className="max-w-[171px] w-full flex items-center justify-center gap-2 h-[52] bg-[#029fae] rounded-b-lg cursor-pointer text-white capitalize">
                  shop now <MoveRight />
                </button>
              </div>

              {/* banner image */}
              <div className="banner_image w-full h-full">
