              ...
              <div key={index} className="p-4 h-[424px]">
                <div className="feature_image mb-4 relative">
                  <img
                    ...
                    alt={category?.title}
                  />
                  <div className="absolute bottom-0 left-0 w-full h-[85px] bg-[#000000] bg-opacity-50 flex items-center justify-center">
                    <h4 className="text-xl text-white font-inter font-semibold mb-4 capitalize">
                      {category?.title}
                    </h4>
