    ...
    <div className="lg:container mx-auto p-[80px]">
      <div className="flex items-center mx-auto max-w-[648px] w-full min-h-[382px] p-[31px] justify-center flex-col rounded-lg border-[#9a9caa] border-[1px]">
        ...
        >
          ...
          />
          <button
            className="w-full cursor-pointer justify-center h-[50px] bg-[#007580] rounded-lg pl-3.5 text-base text-white font-semibold font-inter capitalize flex items-center gap-2.5 mt-4"
            type="submit"
          >
            Register <MoveRight />
          </button>
